...
class NearByCabs extends StatefulWidget {
  NearByCabs({
    super.key,
  ...
  @override
  State<NearByCabs> createState() => _NearByCabsState();
}

class _NearByCabsState extends State<NearByCabs> {
  var flag = 0;
  var status;
  var lat, long;
  var res;
                      ...
                      child: Row(
                        children: [
                          Container(
                            ...
                            width: 150,
                            child: Image.network(
                              "${Con.url}cabs/${nearbyStations[index]['image']}",
                              fit: BoxFit.fill,
                            ),
                          ),
                          SizedBox(
