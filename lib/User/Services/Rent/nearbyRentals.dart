...
class NearByRentals extends StatefulWidget {
  NearByRentals({
    super.key,
  ...
  @override
  State<NearByRentals> createState() => _NearByRentalsState();
}

class _NearByRentalsState extends State<NearByRentals> {
  var flag = 0;
  var status;
  var lat, long;
  var res;
                      ...
                      child: Row(
                        children: [
                          Container(
                            ...
                            width: 150,
                            child: Image.network(
                              "${Con.url}rentals/${nearbyStations[index]['image']}",
                              fit: BoxFit.fill,
                            ),
                          ),
                          SizedBox(
