...
class CabPay extends StatefulWidget {
  CabPay({Key? key, required this.bookingID, required this.amt})
      : super(key: key);
  var bookingID;
  var amt;
  @override
  State<CabPay> createState() => _CabPayState();
}

class _CabPayState extends State<CabPay> {
  ...
  Future<dynamic> sentData() async {
    ...
    print(data);
    var response =
        await post(Uri.parse('${Con.url}USER/Payment/cabPay.php'), body: data);
    print(response.body);
