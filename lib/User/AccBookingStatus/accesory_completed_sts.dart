...
class AccessoryCompletedSts extends StatefulWidget {
  const AccessoryCompletedSts({Key? key}) : super(key: key);

  @override
  State<AccessoryCompletedSts> createState() => _AccessoryCompletedStsState();
}

class _AccessoryCompletedStsState extends State<AccessoryCompletedSts> {
